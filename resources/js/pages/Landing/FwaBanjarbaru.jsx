...
const BENEFIT_POINTS = [
    {
        title: 'Tanpa penarikan kabel',
        description: 'Cocok untuk rumah yang lokasinya belum dilewati jaringan fiber.',
    },
    {
        title: 'Perangkat sudah termasuk',
        description: 'Modem disediakan dan dirawat selama kamu berlangganan.',
    },
    {
        title: 'Bisa dipindah',
        description: 'Kalau pindah rumah di area terjangkau, layanan bisa ikut pindah.',
    },
];

const FAQ_ITEMS = [
    {
        question: 'Apakah FWA terpengaruh cuaca?',
        answer: 'Kualitas koneksi bisa sedikit turun saat hujan sangat deras, tapi perangkat kami dipilih supaya tetap stabil di kondisi normal.',
    },
];
                ...
                <Container className="relative">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/90 md:text-lg">
                            Solusi untuk area yang belum terjangkau fiber. Modem dipasang di rumah, koneksi langsung jalan.
                        </p>
