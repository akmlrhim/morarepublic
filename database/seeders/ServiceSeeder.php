    ...
    public function run(): void
    {
        $services = [
            [
                ...
                'benefits' => [
                    'Pemasangan cepat, umumnya selesai dalam satu kunjungan',
                    'Tanpa penarikan kabel ke dalam rumah',
                    'Perangkat modem sudah termasuk dalam paket',
                    'Bisa dipindah kalau kamu pindah rumah di area terjangkau',
                ],
            ...
            [
                ...
                'benefits' => [
                    'Kecepatan unduh dan unggah yang seimbang',
                    'Stabil walau banyak perangkat terhubung bersamaan',
                    'Router dual band sudah termasuk',
                    'Prioritas penanganan gangguan',
                ],
